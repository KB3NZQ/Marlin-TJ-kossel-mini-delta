...
// #define  DEFAULT_bedKp 58.34
 ...
 //D-force
  #define  DEFAULT_bedKp 79.48
  #define  DEFAULT_bedKi 15.35
 #define  DEFAULT_bedKd 102.87
...
#define MANUAL_Z_HOME_POS 317// For delta: Distance between nozzle and print surface after homing.
...
#define Z_PROBE_OFFSET {0, 0, 0.1, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 89.5}

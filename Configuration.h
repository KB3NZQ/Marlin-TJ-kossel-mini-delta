...
#define Z_MIN_POS 19 // orgional value 0 probed bed came to 19.7 tight on peace of printer paper
...
#define MANUAL_Z_HOME_POS 310// For delta: Distance between nozzle and print surface after homing.
...
#define Z_PROBE_OFFSET {0, 0, 0.7, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 100, 160}
